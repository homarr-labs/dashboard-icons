...
describe("Simple Icons PNG route", () => {
	...
	it("returns a rasterized PNG for the requested variant", async () => {
		...
		expect(mockRasterizeRemoteSvg).toHaveBeenCalledWith("https://cdn.jsdelivr.net/npm/simple-icons@16.0.0/icons/github.svg", 640, "#000000")
	...
	it("applies brand color for the brand variant", async () => {
		...
		expect(mockRasterizeRemoteSvg).toHaveBeenCalledWith("https://cdn.jsdelivr.net/npm/simple-icons@16.0.0/icons/github.svg", 640, "#181717")
	})
