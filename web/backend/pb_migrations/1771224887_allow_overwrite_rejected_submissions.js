...
migrate((app) => {
  ...
  // Update the updateRule to allow anyone to overwrite rejected submissions
  // Users can update if they are the creator, an admin, or if the submission is rejected
